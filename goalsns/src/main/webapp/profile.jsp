      ...
      <div class="modal-content">    
        ...
        <div class="follower-box">
	        ...
	        <div class="follower_list">
	        	<a href="/goalsns/profile.do?mem_id=${fled.from_mem}"><img id="peedimg" class="img-circle" src="./resources/images/profile.png" width="50" height="50" ></a>
	        	<a href="/goalsns/profile.do?mem_id=${fled.from_mem}" name="mem_id" class="mem_id">${fled.from_mem}</a> 
	        </div>
	        </c:forEach>
        </div>       
      </div>    
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">     
        ...
        <div class="follower-box">
	        ...
	        <div class="follower_list">
	        	<a href="/goalsns/profile.do?mem_id=${fl.to_mem}"><img id="peedimg" class="img-circle" src="./resources/images/profile.png" width="50" height="50" ></a>
	        	<a href="/goalsns/profile.do?mem_id=${fl.to_mem}" name="mem_id" class="mem_id">${fl.to_mem}</a>
